...
self-collision pruning. SVGD uses option-B in-kernel collision: the analytical
collision gradient is added to ``grad_logp`` so particles actively repel from
obstacles (not merely tracked-for-best as in the LM samplers).
