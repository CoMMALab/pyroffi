...
def stage_a(root="scratch/viz/multiseed", seed0=None):
...
def stage_b(root="scratch/viz/multiseed", extra=("scratch/viz/multistart_behavior.npz",)):
...
if __name__ == "__main__":
    ...
    seed0 = {}
    for space, path in (("joint", "scratch/viz/loss_space_joint.npz"),
                        ("ee", "scratch/viz/loss_space_ee.npz")):
