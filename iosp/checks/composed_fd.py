...
The second row is `iosp.model.pickplace.make_composed_forward_solver`'s default, which
...
def main():
    """Runs the sweep.  Called from `__main__` only -- this module used to
    execute at IMPORT time and so could not be imported without GPU work."""
