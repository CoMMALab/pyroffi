#!/usr/bin/env bash
# Build _analytic_ik_cuda_lib.so from _analytic_ik_cuda_kernel.cu.
#
# Usage (from repo root):
#   bash build_kernels/build_analytic_ik_cuda.sh
#   bash build_kernels/build_analytic_ik_cuda.sh --debug
#
# Requirements:
#   - nvcc (CUDA toolkit)
...
SRC="${KERNELS_DIR}/ik/_analytic_ik_cuda_kernel.cu"
OUT="${KERNELS_DIR}/ik/_analytic_ik_cuda_lib.so"
