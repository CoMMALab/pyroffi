#!/usr/bin/env bash
# Build collision/_fused_self_collision_lib.so from collision/_fused_self_collision_kernel.cu.
#
...
SRC="${KERNELS_DIR}/collision/_fused_self_collision_kernel.cu"
OUT="${KERNELS_DIR}/collision/_fused_self_collision_lib.so"
