#!/usr/bin/env bash
# Build _canonical_ik_lib.so from _canonical_ik_kernel.cu.
#
# Usage (from repo root):
#   bash build_kernels/build_canonical_ik_cuda.sh
#   bash build_kernels/build_canonical_ik_cuda.sh --debug
#
# Requirements:
#   - nvcc (CUDA toolkit)
...
SRC="${KERNELS_DIR}/ik/_canonical_ik_kernel.cu"
OUT="${KERNELS_DIR}/ik/_canonical_ik_lib.so"
...
# Override for a specific arch: GPU_ARCH=-arch=sm_80 bash build_canonical_ik_cuda.sh
